...
<body class="fix-header">
						...
						<div class="white-box">
							...
							<button class="add">
								<i class="fa fa-plus-square"></i><a
									href="${base}/admin1/thuonghieu/themthuonghieu">Thêm thương hiệu</a>
							</button>
							<div class="table-responsive">
								<table class="table table-bordered" style="text-align: center;">
									...
									<tbody>
										<c:forEach items="${listThuongHieu}" var="listThuongHieu"
											varStatus="loop">
											<tr>
												<td>${loop.index+1}</td>
												<td>${listThuongHieu.id}</td>
												<td>${listThuongHieu.tenThuongHieu}</td>
												<td>${listThuongHieu.sanPhams.size()}</td>
												<td>${listThuongHieu.moTa}</td>
											
												<%-- <td>${listDanhMuc.childs.tenDanhMuc}</td> --%>
												<td>
													<div class="table-data-feature">

														<a href="${base}/admin1/thuonghieu/edit/${listThuongHieu.id}"
															class="btn btn-primary" data-toggle="tooltip" data-placement="top"
															title="Edit"> <i class="fa fa-edit"></i></i>
														</a>
														<button class="btn btn-danger"
															onclick="setIdDelete(${listThuongHieu.id})"
							...
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title" id="deleteDM">Xóa thương hiệu</h5>
    ...
    function setIdDelete(id)
    {
    	...
    	form.setAttribute("action","/admin1/thuonghieu/delete/"+id+"");
    	console.log(id);
    }
    </script>
</body>

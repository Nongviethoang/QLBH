...
<body class="fix-header">
						...
						<div class="white-box">
							...
							<div class="table-responsive">
								<table class="table">
									...
									<tbody>
										<c:forEach items="${listBinhLuan}" var="bl" varStatus="loop">
											<tr>
												<td>${loop.index +1}</td>
												<td>${bl.id}</td>
												<td>${bl.thanhViens.id}</td>
												<td>${bl.sanPhams.id}</td>
												<td>${bl.noiDung}</td>
												<td>${bl.thoiGian}</td>
												<td>
													<div class="table-data-feature">
														...
														<button class="btn btn-danger"
															onclick="setIdDelete(${bl.id})" data-toggle="modal"
							...
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title" id="deleteDM">Xóa bình luận</h5>
    ...
    function setIdDelete(id)
    {
    	...
    	form.setAttribute("action","/admin1/xoabinhluan/"+id+"");
    	console.log(id);
    }
    </script>
